    ...
    for(size_t p = 0; p < platforms.size(); p++) {
        ...
        for(size_t d = 0; d < devices.size(); d++) {
            ...
            try {
                ...
                std::cout << "Preferred WG multiple: " << preferredMultiple << std::endl;
                ...
                std::cout << "Max WG size for kernel: " << maxWGSize << std::endl;                

                // =====================================================================
                // TODO #7: Choose a valid local size using preferred alignment (simple strategy)
                // =====================================================================
                size_t localSize = preferredMultiple;
                if (localSize > maxWGSize)
                    localSize = maxWGSize;
                std::cout << "  Using local size: " << localSize << std::endl;
